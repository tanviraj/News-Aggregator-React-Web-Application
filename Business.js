...
class Business extends React.Component {
  ...
  componentDidMount() {
    ...
    let api = this.state.checked ? `https://tanvi1.azurewebsites.net/api/isGuardian/business` : `https://tanvi1.azurewebsites.net/api/isNy/business`;
    fetch(api)
  ...
  componentDidUpdate() {
    if (this.props.isGuardian !== this.state.checked) {
      ...
      let api = this.props.isGuardian ? `https://tanvi1.azurewebsites.net/api/isGuardian/business` : `https://tanvi1.azurewebsites.net/api/isNy/business`;
      fetch(api)
        .then(response => response.json())
        .then(response => {
          const { results } = response.data;
