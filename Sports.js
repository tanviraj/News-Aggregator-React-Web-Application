...
class Sports extends React.Component {
  ...
  componentDidMount() {
    let api = this.state.checked ? `https://tanvi1.azurewebsites.net/api/isGuardian/sport` : `https://tanvi1.azurewebsites.net/api/isNy/sports`;
    fetch(api)
  ...
  componentDidUpdate() {
    if (this.props.isGuardian !== this.state.checked) {
      ...
      let api = this.props.isGuardian ? `https://tanvi1.azurewebsites.net/api/isGuardian/sport` : `https://tanvi1.azurewebsites.net/api/isNy/sports`;
      fetch(api)
        .then(response => response.json())
        .then(response => {
          const { results } = response.data;
